...
import ButtonComponent from "../../components/TextInputComponent/TextInputComponent";
        ...
        <View style={styles.container}>
            <ImageBackground resizeMode='cover' source={require('../../../assets/images/welcomeScreen.png')} style={styles.backgroundImage}>
                <LinearGradient colors={COLORS.map(item => item.color)}
                    ...
                    <ButtonComponent title="Get Started" onPress={onPressGetStarted} buttonStyle={{paddingHorizontal: 50}}/>
                </LinearGradient>
            </ImageBackground>
        </View>
    );
